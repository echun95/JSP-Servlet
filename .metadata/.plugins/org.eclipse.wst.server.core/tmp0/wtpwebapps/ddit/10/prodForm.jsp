...
<table width="600" border="0" cellpadding="0" cellspacing="0">
   ...
   <tr>
      ...
      <td>
         <div id="div1" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="text" id="prod_buyer" name="prod_buyer">
            <label class="mdl-textfield__label" for="prod_buyer" id = "buyer_label">거래처코드</label>
         </div>
         <!-- 
