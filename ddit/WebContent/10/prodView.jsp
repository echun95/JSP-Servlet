...
<table width="600" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" value="<%=vo.getProd_id()%>" type="text" id="prod_id" name="prod_id" disabled="disabled">
				<input class="mdl-textfield__input" value="<%=vo.getProd_id()%>" type="hidden" id="prod_id" name="prod_id">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" value="<%=vo.getProd_name()%>" id="prod_name" name="prod_name" disabled="disabled">
				<input class="mdl-textfield__input" type="hidden" value="<%=vo.getProd_name()%>" id="prod_name" name="prod_name">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" value="<%=vo.getProd_lgu()%>" id="prod_lgu" name="prod_lgu" disabled="disabled">
				<input class="mdl-textfield__input" type="hidden" value="<%=vo.getProd_lgu()%>" id="prod_lgu" name="prod_lgu">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" value="<%=vo.getProd_buyer()%>" id="prod_buyer" name="prod_buyer" disabled="disabled">
				<input class="mdl-textfield__input" type="hidden" value="<%=vo.getProd_buyer()%>" id="prod_buyer" name="prod_buyer">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_cost" value="<%=vo.getProd_cost()%>" name="prod_cost">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_price" name="prod_price" value="<%=vo.getProd_price()%>">
...
<table width="600" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_sale" name="prod_sale" value="<%=vo.getProd_sale()%>">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_outline" name="prod_outline" value="<%=vo.getProd_outline()%>">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_detail" name="prod_detail" value="<%=vo.getProd_detail()%>">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_qtyin" name="prod_qtyin" value="<%=vo.getProd_qtyin()%>">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_totalstock" name="prod_totalstock" value="<%=vo.getProd_totalstock()%>">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_properstock" name="prod_properstock" value="<%=vo.getProd_properstock()%>">
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="prod_insdate" name="prod_insdate" value="<%=vo.getProd_insdate()%>">
