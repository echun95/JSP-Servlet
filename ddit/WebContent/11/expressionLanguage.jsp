...
<table>
	...
	<tr>
		<td><%=application.getInitParameter("oralceDriver") %></td>
...
session<br/>
집 전화번호  : ${sessionScope.memberInfo.mem_hometel }<br/>
회사 전화번호  : ${requestScope.memberInfo.mem_comtel }<br/>
휴대폰 번호 : ${requestScope.memberInfo.mem_hp }<br/>
application<br/>
...
<h3>쿼리스트링 취득</h3>
<!-- 
	* 디클레이션 또는 스크립트릿 내에서 EL 선언 불가능
	* EL은 자바스크립트 또는 html 내에서 활용
	http://localhost/ddit/11/expressionLanguage.jsp?mem_id=b001&mem_pass=1004
 -->
<table>
	<tr>
		<td>표기법</td><td>결과값</td>
...
${hets[5] }<br/>
<h3>삼항 연산자</h3>
Expression : <%=(pageContext.getAttribute("memberInfo") != null ? "널이 아님" : "널") %><br/>
