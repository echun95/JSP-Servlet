...
<table width="600" border="0" cellpadding="0" cellspacing="0">
	<input type="hidden" value="${buyerInfo.buyer_id }" id="buyer_id" name="buyer_id">
	<tr>
	...
	<tr>
		...
		<td>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="buyer_name" value="${buyerInfo.buyer_name }" name="buyer_name">
...
<table width="600" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
	...
	<tr>
		<td class="btnGroup" colspan="2" >
			<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" id="btn1" type="submit">거래처 정보수정</button>
			<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" id="btn2" type="button">거래처 정보삭제</button>
