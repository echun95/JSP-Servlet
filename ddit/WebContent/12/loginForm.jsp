...
<c:url var="insertMemberURI" value="/12/main.jsp">
	<c:param name="contentPage" value="/09/memberForm.jsp"></c:param>
</c:url>
<c:url var="loginCheckURI" value="/12/loginCheck.jsp"></c:url>
					...
					<tr>
						...
						<td>
							<table border="0" align="center" cellpadding="5"
								...
								<tr>
									<td colspan="3" align="right"><a href="${insertMemberURI}">회원가입을 원하세요??</a></td>
								</tr>
							</table>
						</td>
					</tr>
